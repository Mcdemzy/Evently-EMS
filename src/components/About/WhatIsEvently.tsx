...
const WhatIsEvently: React.FC = () => {
  return (
    <section className="bg-[#EDEFFF] w-full py-10 lg:py-16 px-4 lg:px-24 dark:bg-black dark:text-white">
      <h1 className="text-[#624CF5] text-xl lg:text-2xl font-semibold leading-8 mb-6 text-center lg:text-left dark:text-[#EDEFFF]">
        What is Evently?
      </h1>
      <div className="text-[#1C1C1C] text-base lg:text-lg font-normal text-justify flex flex-col gap-6 leading-7 lg:leading-8 dark:text-[#EDEFFF]">
        <p>
