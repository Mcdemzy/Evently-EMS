      ...
      <div className="min-h-screen flex flex-col items-center py-8">
        <div className="w-full max-w-6xl p-4 lg:flex lg:space-x-8">
          ...
          <div className="lg:w-1/2 mt-8 lg:mt-0">
            <h1 className="text-4xl text-[#25194D] font-bold">
              PARTY W ZEIGHT
            </h1>
            <div className="mt-6 flex items-center space-x-3">
              <span className="bg-[#25194D] text-[#EDEFFF] px-4 py-2 rounded-full font-bold text-base">
                Free
              </span>
              <span className="text-base text-[#25194D]">Pool Party</span>
            </div>
            <div className="mt-8">
              <div className="flex items-center space-x-3">
                <FaCalendarAlt className="text-[#25194D] text-xl" />
                <span className="text-[#25194D] text-lg">Sep 13, 2024</span>
              </div>
              <div className="flex items-center space-x-3 mt-4">
                <FaClock className="text-[#25194D] text-xl" />
                <span className="text-[#25194D] text-lg">1:00 PM</span>
              </div>
              <div className="flex items-center space-x-3 mt-4">
                <FaMapMarkerAlt className="text-[#25194D] text-xl" />
                <span className="text-[#25194D] text-lg">
                  The Zone, Gbagada
                </span>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <p className="mt-6 text-[#25194D] text-lg leading-relaxed">
        ...
        <div className="w-full max-w-6xl p-4 mt-16">
          <h2 className="text-2xl font-bold text-[#25194D]">Directions</h2>
          <div className="mt-6">
            <img
        ...
        <div className="w-full max-w-6xl p-4 mt-16 place-items-center">
          <h2 className="text-2xl font-bold text-[#25194D]">Contact Us</h2>
